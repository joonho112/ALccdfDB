...
#> 
#> ── Processing Log
#> [2026-02-15 21:52:51] Linked programs x enrolled: 33/50 programs matched (66%),
#> 80 enrolled records
```
...
#> 
#> ── Processing Log
#> [2026-02-15 21:52:52] Linked programs x clients: 32/50 programs matched (64%),
#> 40 client records
```
...
#> 
#> ── Processing Log
#> [2026-02-15 21:52:52] Linked programs x staff: 28/50 programs matched (56%), 60
#> staff records
```
...
#> 
#> ── Processing Log
#> [2026-02-15 21:52:53] Linked clients x programs: 40/40 client rows matched
