...
**5 facility types:** Center, Family Home, Group Home, Faith-Based, Excepted
**5 quality tiers:** Star 1 through Star 5 (ordered factor)
**3 quality weight schemes:** linear (0.2--1.0), binary (0.0/1.0), exponential (0.1--1.0)
...
- **Five facility types** -- Center, Family Home, Group Home,
  ...
  unified pipeline.
- **Quality tier recoding** -- Star 1 through Star 5 as an ordered
  factor with three weighting schemes (linear, binary, exponential).
...
- **Multi-format export** -- one-call export to CSV, Excel, Stata
  `.dta`, Parquet, and RDS.
...
- **Comprehensive test suite** -- 1,088 expectations across 8 test
  files; R CMD check passes cleanly.
